...
public class FlacCueSheetTrack(long trackOffset, int trackNumber, string trackIsrc, FlacCueSheetTrackType trackType, FlacCueSheetPreEmphasis preEmphasis, byte[] reserved, int trackIndexCount, IEnumerable<FlacCueSheetTrackIndexPoint> indexPoints)
{
    ...
    /// </remarks>
    public long TrackOffset { get; private set; } = trackOffset;
    ...
    /// </remarks>
    public int TrackNumber { get; private set; } = trackNumber;
    ...
    /// </remarks>
    public string TrackIsrc { get; private set; } = trackIsrc;
    ...
    /// </value>
    public FlacCueSheetTrackType TrackType { get; private set; } = trackType;
    ...
    /// The pre emphasis.
    /// </value>
    public FlacCueSheetPreEmphasis PreEmphasis { get; private set; } = preEmphasis;
    ...
    /// </remarks>
    public byte[] Reserved { get; private set; } = reserved;
    ...
    /// </remarks>
    public int TrackIndexCount { get; private set; } = trackIndexCount;
