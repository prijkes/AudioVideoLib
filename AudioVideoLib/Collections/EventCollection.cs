...
public class EventCollection<T> : ICollection<T>
{
    ...
    {
        var itemAddEventArgs = new CollectionItemAddEventArgs<T>(item);
        OnItemAdd(itemAddEventArgs);

        if (!itemAddEventArgs.Cancel)
        {
            _list.Add(itemAddEventArgs.Item);
            var itemAddedEventArgs = new CollectionItemAddedEventArgs<T>(item);
    ...
    {
        var removeEventArgs = new CollectionItemRemoveEventArgs<T>(item);
        ...
        if (!removeEventArgs.Cancel)
        {
            ...
            {
                var removedEventArgs = new CollectionItemRemovedEventArgs<T>(item);
