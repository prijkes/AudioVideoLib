...
public sealed partial class Id3v2ExtendedHeader
{
    ...
    {
        return version < Id3v2Version.Id3v230 ? 0 : version < Id3v2Version.Id3v240 ? 4 : (version >= Id3v2Version.Id3v240) ? 5 : 0;
    }
    ...
    {
        return version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240
            ? 6 + (CrcDataPresent ? GetCrcDataLength(version) : 0)
            : version >= Id3v2Version.Id3v240
            ? 6 + (TagIsUpdate ? GetTagIsUpdateDataLength(version) : 0) + (CrcDataPresent ? GetCrcDataLength(version) : 0)
    ...
    public int GetFlags(Id3v2Version version)
    {
        ...
        if (CrcDataPresent)
        {
            flags |= (version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240)
    ...
    public int GetFlagsFieldLength(Id3v2Version version)
    {
        return version < Id3v2Version.Id3v230
            ? 0
            : version < Id3v2Version.Id3v240 ? 2 : (version == Id3v2Version.Id3v240) ? 1 : _extendedFlagsFieldLength;
    }
    ...
    private void SetFlags(Id3v2Version version, int extendedFlags)
    {
        ...
        CrcDataPresent = ((version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240)
