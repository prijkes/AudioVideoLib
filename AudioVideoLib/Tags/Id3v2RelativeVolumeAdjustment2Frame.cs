...
public sealed class Id3v2RelativeVolumeAdjustment2Frame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        ...
        protected set
        {
            ...
            while (stream.Position < stream.Length)
            {
                ...
                var volumeAdjustmentInt16 = stream.ReadBigEndianInt16();
                var volumeAdjustment = Convert.ToSingle((double)volumeAdjustmentInt16 / 512);
    ...
    {
        return rva2 is not null && (ReferenceEquals(this, rva2) || ((rva2.Version == Version) && string.Equals(rva2.Identification, Identification, StringComparison.OrdinalIgnoreCase)));
    }
