...
public sealed partial class Id3v2Tag : IAudioTag
{
    ...
    public byte[] ToByteArray()
    {
        ...
        if (ExtendedHeader != null)
        {
            ...
            {
                var extendedHeaderSize = ExtendedHeader.GetHeaderSize(Version);
                var extendedHeaderFlags = ExtendedHeader.GetFlags(Version);
            ...
            else if (Version >= Id3v2Version.Id3v240)
            {
                ...
                var extendedHeaderFlags = ExtendedHeader.GetFlags(Version);
                var extendedHeaderFlagsFieldLength = ExtendedHeader.GetFlagsFieldLength(Version);
                data.WriteBigEndianInt32(extendedHeaderSize);
                ...
                if (ExtendedHeader.CrcDataPresent)
                {
                    var crc = CalculateCrc32() & 0xFFFFFFFF;
                ...
                {
                    var extendedHeaderBytes = ExtendedHeader.TagRestrictions.ToByte();
