...
public sealed class Id3v2GeneralEncapsulatedObjectFrame : Id3v2Frame
{
    ...
    private string _mimeType = null!, _filename = null!, _contentDescription = null!;
    ////------------------------------------------------------------------------------------------------------------------------------
    ...
    public override string Identifier => GetIdentifierFromFactory() ?? "GEOB";
    ...
    {
        return geo is not null && (ReferenceEquals(this, geo) || ((geo.Version == Version) && string.Equals(geo.ContentDescription, ContentDescription, StringComparison.OrdinalIgnoreCase)));
    }
