...
public sealed class Id3v2Equalisation2Frame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            // Adjustment points
            foreach (var adjustmentPoint in AdjustmentPoints)
            {
    ...
    {
        return equalisation2 is not null && (ReferenceEquals(this, equalisation2) || ((equalisation2.Version == Version)
    ...
    {
        return Enum.TryParse(interpolationMethod.ToString(), true, out Id3v2InterpolationMethod _);
    }
    ...
    private void AdjustmentPointAdd(object? sender, ListItemAddEventArgs<Id3v2AdjustmentPoint> e)
    {
        ...
        {
            var adjustmentPoint = _adjustmentPoints[i];
