...
public partial class Id3v2Frame
{
    ...
    public static bool IsValidIdentifier(Id3v2Version version, string identifier)
    {
        return identifier == null
            ...
            : (identifier.Length == GetIdentifierFieldLength(version)) && identifier.All(c => IsValidIdentifierByte((short)c));
    }
    ...
    public static bool IsValidCountryCode(string countryCode)
    {
        return countryCode == null
            ...
            : (countryCode.Length == 2) && CountryCodes.ContainsKey(countryCode);
    }
    ...
    public static bool IsValidCurrencyCode(string currencyCode)
    {
        return currencyCode == null
            ...
            : (currencyCode.Length == 3) && CurrencyCodes.ContainsKey(currencyCode);
    }
    ...
    {
        return url == null ? throw new ArgumentNullException("url") : UrlRegEx.IsMatch(url);
    }
    ...
    public static bool IsValidDefaultTextString(string textString, bool newLineAllowed)
    {
        return textString == null
            ...
            : IsValidTextString(textString, Id3v2FrameEncodingType.Default, newLineAllowed);
    }
    ...
    {
        return Enum.TryParse(timeStampFormat.ToString(), true, out Id3v2TimeStampFormat _);
    }
    ...
    {
        return identifierByte is (>= (short)'A' and <= (short)'Z') or (>= (short)'0' and <= (short)'9');
    }
    ...
    {
        return Enum.TryParse(version.ToString(), true, out Id3v2Version _);
    }
    ...
    private static int GetFrameSize(Id3v2Version version, long frameSize, long maximumFrameSize)
    {
        ...
        if (version >= Id3v2Version.Id3v240)
        {
            ...
            {
                var size = StreamBuffer.SwitchEndianness(frameSize, 4);
