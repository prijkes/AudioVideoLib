...
public sealed class Lyrics3Tag : IAudioTag
{
    ...
    {
        return tag is not null && (ReferenceEquals(this, tag) || string.Equals(tag.Lyrics, Lyrics, StringComparison.OrdinalIgnoreCase));
    }
    ...
    private void SetLyrics(string? value)
    {
        ...
        _lyrics = StreamBuffer.GetTruncatedEncodedBytes(value ?? string.Empty, Encoding, MaxLyricsSize);
