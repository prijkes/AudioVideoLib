...
public sealed class Id3v2EventTimingCodesFrame : Id3v2Frame
{
    ...
    {
        return etc is not null && (ReferenceEquals(this, etc) || etc.Version == Version);
    }
    ...
    private bool IsValidKeyEventType(Id3v2KeyEventType keyEventType)
    {
        ...
        var maxAllowedOrderedKeyFrameType = Version < Id3v2Version.Id3v230
            ? Id3v2KeyEventType.UnwantedNoise
            : Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240 ? Id3v2KeyEventType.ThemeEnd : Id3v2KeyEventType.ProfanityEnd;
