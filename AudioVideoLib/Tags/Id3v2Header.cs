...
public partial class Id3v2Tag
{
    ...
    public int Flags
    {
        get
        {
            ...
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230HeaderFlags.ExtendedHeader
            ...
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230HeaderFlags.ExperimentalIndicator
        ...
        private set
        {
            ...
            UseExtendedHeader = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230HeaderFlags.ExtendedHeader)
                                     : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240HeaderFlags.ExtendedHeader)
                                     : 0) != 0;

            TagIsExperimental = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230HeaderFlags.ExperimentalIndicator)
