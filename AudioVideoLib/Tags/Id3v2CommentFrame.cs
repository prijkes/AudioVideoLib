...
public sealed class Id3v2CommentFrame : Id3v2Frame
{
    ...
    public Id3v2FrameEncodingType TextEncoding
    {
        ...
        set
        {
            ValidateEncodedText(ShortContentDescription, value, nameof(ShortContentDescription), false);
            ValidateEncodedText(Text, value, nameof(Text), true);
            field = value;
        }
    }
    ...
    public override string Identifier => GetIdentifierFromFactory() ?? "COMM";
