...
public class Id3v2AdjustmentPoint(short frequency, short volumeAdjustment)
{
    ...
    /// </remarks>
    public short Frequency { get; private set; } = frequency;
    ...
    /// </remarks>
    public short VolumeAdjustment { get; private set; } = volumeAdjustment;
}
