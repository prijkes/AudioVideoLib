...
public sealed class Id3v2PopularimeterFrame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            if (Counter > 0)
            {
                stream.WriteBigEndianBytes(Counter, (Counter > int.MaxValue) ? StreamBuffer.Int64Size : StreamBuffer.Int32Size);
            }
    ...
    /// <inheritdoc />
    public override string Identifier => (Version < Id3v2Version.Id3v230) ? "POP" : "POPM";
    ...
    {
        return pm is not null && (ReferenceEquals(this, pm) || ((pm.Version == Version) && string.Equals(pm.EmailToUser, EmailToUser, StringComparison.OrdinalIgnoreCase)));
    }
