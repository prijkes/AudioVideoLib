...
public sealed class Id3v2MpegLocationLookupTableFrame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            // References
            foreach (var mpegLookupTableItem in References)
            {
    ...
    public override string Identifier => GetIdentifierFromFactory() ?? "MLLT";
    ...
    {
        return mllt is not null && (ReferenceEquals(this, mllt) || mllt.Version == Version);
    }
