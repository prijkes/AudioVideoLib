...
public sealed class Id3v2EncryptionMethodRegistrationFrame : Id3v2Frame
{
    ...
    {
        return encryptionMethodRegistrationFrame is not null && (ReferenceEquals(this, encryptionMethodRegistrationFrame) || ((encryptionMethodRegistrationFrame.Version == Version)
