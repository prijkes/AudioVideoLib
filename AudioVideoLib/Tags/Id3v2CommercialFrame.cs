...
public sealed class Id3v2CommercialFrame : Id3v2Frame
{
    ...
    public string PriceString
    {
        ...
        set
        {
            if (!string.IsNullOrEmpty(value))
            {
                ...
                {
                    if ((s.Length < 3) || !IsValidCurrencyCode(s[..3]))
                    {
    ...
    public string ValidUntil
    {
        ...
        set
        {
            ...
            var d = value[..8];
            if (!DateTime.TryParseExact(d, "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None, out _))
            {
    ...
    {
        return commercial is not null && (ReferenceEquals(this, commercial) || ((commercial.Version == Version) && (commercial.TextEncoding == TextEncoding)
    ...
    {
        return Enum.TryParse(audioDeliveryType.ToString(), true, out Id3v2AudioDeliveryType _);
    }
}
