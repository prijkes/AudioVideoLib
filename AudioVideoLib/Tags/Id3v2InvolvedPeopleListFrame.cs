...
public sealed class Id3v2InvolvedPeopleListFrame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            foreach (var ip in InvolvedPeople)
            {
                // Preamble.
    ...
    public override string Identifier => GetIdentifierFromFactory() ?? "IPLS";
    ...
    {
        return ipl is not null && (ReferenceEquals(this, ipl) || ipl.Version == Version);
    }
