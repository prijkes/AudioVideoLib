...
public sealed class Id3v2RelativeVolumeAdjustmentFrame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            var bytesEntry = (int)Math.Ceiling((double)VolumeDescriptionBits / 8);
    ...
    /// <inheritdoc />
    public override string Identifier => (Version < Id3v2Version.Id3v230) ? "RVA" : "RVAD";
    ...
    {
        return rva is not null && (ReferenceEquals(this, rva) || rva.Version == Version);
    }
