...
public sealed class Id3v2SyncedTempoCodesFrame : Id3v2Frame
{
    ...
    public override byte[] Data
    {
        get
        {
            ...
            foreach (var tempCode in TempoData)
            {
        ...
        protected set
        {
            ...
            {
                var beatsPerMinute = stream.ReadByte();
    ...
    public override string Identifier => GetIdentifierFromFactory() ?? "SYTC";
    ...
    private void TempoCodeAdd(object? sender, ListItemAddEventArgs<Id3v2TempoCode> e)
    {
        ...
        for (var i = 0; i < _tempoCodes.Count; i++)
        {
            var tempoCode = _tempoCodes[i];
