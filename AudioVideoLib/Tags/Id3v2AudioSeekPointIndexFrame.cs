...
public sealed class Id3v2AudioSeekPointIndexFrame : Id3v2Frame
{
    ...
    /// </remarks>
    public IList<short> FractionAtIndex => _fractionAtIndex;
    ...
    public override byte[] Data
    {
        get
        {
            ...
            foreach (var i in FractionAtIndex)
            {
        ...
        protected set
        {
            ...
            for (var i = 0; i < NumberOfIndexPoints; i++)
            {
    ...
    /// <inheritdoc />
    public override string Identifier => "ASPI";
    ...
    {
        return audioSeekPointIndexFrame is not null && (ReferenceEquals(this, audioSeekPointIndexFrame) || audioSeekPointIndexFrame.Version == Version);
    }
