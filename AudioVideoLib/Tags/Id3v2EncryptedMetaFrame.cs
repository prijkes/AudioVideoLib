...
public sealed class Id3v2EncryptedMetaFrame : Id3v2Frame
{
    ...
    {
        return emf is not null && (ReferenceEquals(this, emf) || ((emf.Version == Version) && string.Equals(emf.OwnerIdentifier, OwnerIdentifier, StringComparison.OrdinalIgnoreCase)));
    }
