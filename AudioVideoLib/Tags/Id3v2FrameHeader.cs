...
public partial class Id3v2Frame
{
    ...
    public bool TagAlterPreservation
    {
        get
        {
            return (Version >= Id3v2Version.Id3v230) && field;
        }
    ...
    public bool UseUnsynchronization
    {
        get
        {
            return (Version >= Id3v2Version.Id3v240) && field;
        }
    ...
    private int Flags
    {
        get
        {
            ...
            if (!TagAlterPreservation)
            {
                ...
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.TagAlterPreservation
            ...
            if (!FileAlterPreservation)
            {
                // 0 - Frame should be preserved.
                // 1 - Frame should be discarded.
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.FileAlterPreservation
            ...
            if (IsReadOnly)
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.ReadOnly
            ...
            if (UseCompression)
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.Compressed
            ...
            if (UseEncryption)
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.Encrypted
            ...
            {
                flags |= (Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? Id3v230FrameHeaderFlags.GroupingIdentity
        ...
        set
        {
            // 0 - Frame should be preserved.
            // 1 - Frame should be discarded.
            TagAlterPreservation = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.TagAlterPreservation)
                                        : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240FrameHeaderFlags.TagAlterPreservation)
                                        : 0) == 0;

            // 0 - Frame should be preserved.
            // 1 - Frame should be discarded.
            FileAlterPreservation = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.FileAlterPreservation)
                                        : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240FrameHeaderFlags.FileAlterPreservation)
                                        : 0) == 0;

            IsReadOnly = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.ReadOnly)
                              : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240FrameHeaderFlags.ReadOnly)
                              : 0) != 0;

            UseCompression = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.Compressed)
                                  : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240FrameHeaderFlags.Compressed)
                                  : 0) != 0;

            UseEncryption = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.Encrypted)
                                  : (Version >= Id3v2Version.Id3v240) ? (value & Id3v240FrameHeaderFlags.Encrypted)
                                  : 0) != 0;

            UseGroupingIdentity = ((Version is >= Id3v2Version.Id3v230 and < Id3v2Version.Id3v240) ? (value & Id3v230FrameHeaderFlags.GroupingIdentity)
