...
public partial class SytcEditorDialog : Window
{
    public SytcEditorDialog() => InitializeComponent();

    private SytcEditor Editor => (SytcEditor)DataContext;
    ...
    private void Add_Click(object sender, RoutedEventArgs e)
        => Editor.AddRow(new SytcRowVm { BeatsPerMinute = 120, TimeStamp = 0 });
